        ...
        build.setMessage("Are You Sure You Want To Logout?")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dbHelper = new DBHelper(WebviewActivity.this);
                        dbHelper.logout();
                        Intent intent = new Intent(WebviewActivity.this, LoginActivity.class);
                        startActivity(intent);
                        finish();
                        Toast.makeText(WebviewActivity.this,"See You Soon :)",Toast.LENGTH_SHORT).show();
                    }
                } )
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Toast.makeText(WebviewActivity.this,"You Have Come Back",Toast.LENGTH_SHORT).show();
