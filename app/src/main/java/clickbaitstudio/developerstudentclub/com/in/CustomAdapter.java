...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
       ...
       // Glide.with(context).load(my_data.get(position).getImage_link()).into(holder.imageView);
        ...
        else if( my_data.get(position).getfromimage_link().equals("Faculty.jpeg"))
        {
            Glide.with(context).load(R.drawable.faculty).into(holder.fromimageView);
        }
       else  if( my_data.get(position).getfromimage_link().equals("Office.jpeg"))
        {
            Glide.with(context).load(R.drawable.principal).into(holder.fromimageView);
        }
       else if  ( my_data.get(position).getfromimage_link().equals("ECEHOD.jpeg") )
        {
            Glide.with(context).load(R.drawable.ecehod).into(holder.fromimageView);
        }
        ...
        else if( my_data.get(position).getfromimage_link().equals("ITHOD.jpeg"))
        {
            Glide.with(context).load(R.drawable.csehod).into(holder.fromimageView);
        }
        else if( my_data.get(position).getfromimage_link().equals("CIVILHOD.jpeg"))
        {
            Glide.with(context).load(R.drawable.csehod).into(holder.fromimageView);
        }
        else if( my_data.get(position).getfromimage_link().equals("MECHHOD.jpeg"))
        {
            Glide.with(context).load(R.drawable.csehod).into(holder.fromimageView);
        }
