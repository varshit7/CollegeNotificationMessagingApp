...
// return inflater.inflate(R.layout.fragment_three, container, false);
       ...
       // pDialog.setCancelable(false);pDialog.show();
        ...
        webView.loadUrl(Global.ROOT_URL+"photosharing/?rn="+Global.au.Roll_No+"&&name="+Global.au.Name);
      //  webView.loadUrl(Global.ROOT_URL+"laa.html");
        // webView.getSettings().setBuiltInZoomControls(true);// image zoom
