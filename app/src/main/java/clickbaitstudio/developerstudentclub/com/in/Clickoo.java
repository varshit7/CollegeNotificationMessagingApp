...
public class Clickoo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav_Name.setAutoLinkMask(0); // This Line Is need fot Link Movement to work
        nav_Name.setText( Html.fromHtml(Global.description));
        //  Html.fromHtml("<h2>Title</h2><br><p>Description here</p>")
        nav_Name.setMovementMethod(LinkMovementMethod.getInstance());
        ...
        img.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(extension.equals("pdf")||extension.equals("docx")||extension.equals("doc"))
                {
                    ...
                    webView.getSettings().setBuiltInZoomControls(true);// image zoom ikada aithe
...
//###########Below code for loading student picture on load starts from here#####/////////
    ...
    public void ic_heart_click(View v) {
        ...
        else if(Global.liked.equals("0"))
        {
            ...
            final MediaPlayer mp1 = MediaPlayer.create(Clickoo.this, R.raw.beep);
            mp1.start();
